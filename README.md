...
- [Constructor and Destructor Python Example](practise/class_and_destructors.py)
- [Monitor On-Prem Linux Server with Python](practise/on-perm-server-monitor.py)
